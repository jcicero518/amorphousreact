    ...
    _createClass(Pagination, [{
        ...
        value: function renderPage(payload) {
            payload.forEach(function (post) {
                var template = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"../templates/codePost.hbs\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
