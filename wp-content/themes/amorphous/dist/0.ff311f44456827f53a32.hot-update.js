...
var PagesApi = function () {
    ...
    _createClass(PagesApi, [{
        ...
        key: "getPageByPath",
        value: function getPageByPath(path) {
            var _this = this;

            return new Promise(function (resolve, reject) {
                _axios2.default.get(_this.themeRest + "amorphous-theme/v1/prettyPermalink/" + path).then(function (response) {
        ...
        value: function getPage() {
            ...
            return new Promise(function (resolve, reject) {
                _axios2.default.get(_this2.postIdEndPoint).then(function (response) {
                    resolve(Object.assign([], response.data));
                });
            });
        }
        ...
        value: function getPages() {
            ...
            return new Promise(function (resolve, reject) {
                _axios2.default.get(_this3.pagesEndPoint).then(function (response) {
                    resolve(Object.assign([], response.data));
                });
            });
