...
var App = function (_React$Component) {
    ...
    _createClass(App, [{
        ...
        value: function componentWillMount() {
            ...
            var promise = this.props.actions.loadPageByPath(path);
            promise.then(function (response) {
                console.log(response, 'resp of loadpagebypath');
            });
        }
    }, {
...
function loadPathSuccess(pagePath) {
    return {
        type: types.ROUTER,
        pagePath: pagePath
    };
...
function loadPageByPath(path) {
    ...
    return function (dispatch) {
        ...
        return api.getPageByPath(path).then(function (payload) {
            dispatch(loadPathSuccess(payload));
