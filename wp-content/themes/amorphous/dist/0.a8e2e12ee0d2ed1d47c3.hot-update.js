...
var hbTemplate = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./template.handlebars\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
    ...
    _createClass(Pagination, [{
        ...
        value: function renderPage(payload) {
            payload.forEach(function (post) {
                ...
                var element = document.createElement('DIV', fragment);
