    ...
    _createClass(Pagination, [{
        ...
        value: function renderPage(payload) {
            payload.forEach(function (post) {
                //let template = require('../../templates/codePost.hbs')( post );
                console.log(_codePost2.default);
                var eachTemplate = (0, _codePost2.default)();
                categoryMount.insertAdjacentHTML('beforeend', template);
